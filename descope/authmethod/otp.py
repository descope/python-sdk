...
class OTP(AuthBase):
    ...
    async def sign_in_async(
        ...
        """
        Asynchronously sign in (log in) an existing user with the unique login_id you provide. (See 'sign_up' function for an explanation of the
            login_id field.) Provide the DeliveryMethod required for this user. If the login_id value cannot be used for the
            DeliverMethod selected (for example, 'login_id = 4567qq445km' and 'DeliveryMethod = email')
    ...
    async def sign_up_async(
        ...
        """
        Asynchronously sign up (create) a new user using their email or phone number. Choose a delivery method for OTP
            verification, for example Email, SMS, Voice call, or WhatsApp.
            (optional) Include additional user metadata that you wish to preserve.
    ...
    async def sign_up_or_in_async(
        ...
        """
        Asynchronously Sign_up_or_in lets you handle both sign up and sign in with a single call. Sign-up_or_in will first determine if
            login_id is a new or existing end user. If login_id is new, a new end user user will be created and then
            authenticated using the OTP DeliveryMethod specified. If login_id exists, the end user will be authenticated
            using the OTP DeliveryMethod specified.

        Args:
        method (DeliveryMethod): The method to use for delivering the OTP verification code to the user, for example Email, SMS, Voice call, or WhatsApp
        login_id (str): The login ID of the user being validated
    ...
    async def verify_code_async(
        ...
        """
        Asynchronously verify the validity of an OTP code entered by an end user during sign_in or sign_up.
        (This function is not needed if you are using the sign_up_or_in function.
    ...
    async def update_user_email_async(
        ...
        """
        Asynchronously update the email address of an end user, after verifying the authenticity of the end user using OTP.
    ...
    async def update_user_phone_async(
        ...
        """
        Asynchronously update the phone number of an existing end user, after verifying the authenticity of the end user using OTP.
