...
class Password(HTTPBase):
    def get_settings(self, tenant_id: str = "") -> dict:
        ...
        response = self._http.get(MgmtV1.password_settings_path, params=params)
        return response.json()

    def configure_settings(self, tenant_id: str, settings: dict):
        """
        ...
        self._http.post(MgmtV1.password_settings_path, body=body)
