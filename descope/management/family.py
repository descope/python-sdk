...
class Family(FamilyBase, HTTPBase):
    def create(
        self,
        name: str,
    ...
    def delete(self, id: str) -> None:
        ...
        """
        self._http.post(MgmtV1.family_delete_path, body={"id": id})
    ...
    def delete_dependent(self, user_id: str) -> None:
        """
        ...
        AuthException: raised if delete operation fails
        """
        self._http.post(MgmtV1.family_dependent_delete_path, body={"userId": user_id})

    def impersonate_dependent(
        self,
    ...
    def load_settings(self) -> dict:
        ...
        """
        response = self._http.get(MgmtV1.family_settings_path)
        return response.json()
    ...
    def load_custom_attributes(self) -> dict:
        ...
        AuthException: raised if load operation fails
        """
        response = self._http.get(MgmtV1.family_load_custom_attributes_path)
        return response.json()

    def create_custom_attributes(self, attributes: List[CustomAttribute]) -> dict:
        """
    ...
    def delete_custom_attributes(self, names: List[str]) -> dict:
        """
