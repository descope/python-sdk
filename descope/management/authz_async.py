...
class AuthzAsync(AsyncHTTPBase):
    """Async counterpart of Authz — all HTTP calls are coroutines."""

    def __init__(self, http_client, fga_cache_url: Optional[str] = None):
        super().__init__(http_client)
        self._fga_cache_url = fga_cache_url

    async def save_schema(self, schema: dict, upgrade: bool = False):
        """
    ...
    async def save_namespace(self, namespace: dict, old_name: str = "", schema_name: str = ""):
        """
    ...
    async def delete_namespace(self, name: str, schema_name: str = ""):
        """
    ...
    async def save_relation_definition(
        self,
    ...
    async def delete_relation_definition(self, name: str, namespace: str, schema_name: str = ""):
        """
    ...
    async def delete_relations_for_resources(
        self,
        resources: List[str],
    ):
        """
    ...
    async def who_can_access(self, resource: str, relation_definition: str, namespace: str) -> List[dict]:
        """
    ...
    async def resource_relations(self, resource: str) -> List[dict]:
        """
    ...
    async def targets_relations(self, targets: List[str]) -> List[dict]:
        """
    ...
    async def what_can_target_access(self, target: str) -> List[dict]:
        """
    ...
    async def get_modified(self, since: Optional[datetime] = None) -> dict:
        """
