...
class SSOApplicationAsync(SSOApplicationBase, AsyncHTTPBase):
    ...
    async def create_wsfed_application(
        self,
        name: str,
        login_page_url: str,
        realm: str,
        ...
        response = await self._http.post(
            uri,
            body=SSOApplicationAsync._compose_create_update_wsfed_body(
                name,
                login_page_url,
                realm,
                reply_url,
    ...
    async def update_wsfed_application(
        self,
        id: str,
        name: str,
        login_page_url: str,
    ...
    async def get_application_secret(
        self,
        id: str,
    ) -> str:
        """
