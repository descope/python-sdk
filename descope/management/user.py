...
class User(AuthBase):
    ...
    async def patch_async(
        ...
        AuthException: raised if patch operation fails
        """
        response = await self._auth.do_patch_async(
            MgmtV1.user_patch_path,
            User._compose_patch_body(
                login_id,
                email,
    ...
    async def delete_by_user_id_async(
        self,
        user_id: str,
    ):
        """
    ...
    async def delete_all_test_users_async(
        self,
    ):
        """
        Delete all test users in the project. IMPORTANT: This action is irreversible. Use carefully.
    ...
    async def load_by_user_id_async(
        self,
        user_id: str,
    ) -> dict:
        """
    ...
    async def logout_user_by_user_id_async(
        self,
        user_id: str,
    ):
        """
    ...
    async def search_all_test_users_async(
        self,
        tenant_ids: Optional[List[str]] = None,
        role_names: Optional[List[str]] = None,
        limit: int = 0,
    ...
    async def get_provider_token_async(
        self,
        login_id: str,
        provider: str,
        withRefreshToken: Optional[bool] = False,
    ...
    async def update_login_id_async(
        self,
        login_id: str,
        new_login_id: Optional[str] = None,
    ) -> dict:
    ...
    async def update_display_name_async(
        self,
        login_id: str,
        display_name: Optional[str] = None,
        given_name: Optional[str] = None,
    ...
    async def update_picture_async(
        self,
        login_id: str,
        picture: Optional[str] = None,
    ) -> dict:
    ...
    async def update_custom_attribute_async(
        self, login_id: str, attribute_key: str, attribute_val: Union[str, int, bool]
    ) -> dict:
        """
        Update a custom attribute of an existing user.
    ...
    async def remove_sso_apps_async(
        self,
        login_id: str,
        sso_app_ids: List[str],
    ) -> dict:
    ...
    async def set_tenant_roles_async(
        self,
        login_id: str,
        tenant_id: str,
        role_names: List[str],
    ...
    async def add_tenant_roles_async(
        self,
        login_id: str,
        tenant_id: str,
        role_names: List[str],
    ...
    async def remove_tenant_roles_async(
        self,
        login_id: str,
        tenant_id: str,
        role_names: List[str],
    ...
    async def set_temporary_password_async(
        self,
        login_id: str,
        password: str,
    ) -> None:
    ...
    async def set_active_password_async(
        self,
        login_id: str,
        password: str,
    ) -> None:
    ...
    async def expire_password_async(
        self,
        login_id: str,
    ) -> None:
        """
    ...
    async def remove_all_passkeys_async(
        self,
        login_id: str,
    ) -> None:
        """
    ...
    async def remove_totp_seed_async(
        self,
        login_id: str,
    ) -> None:
        """
    ...
    async def generate_otp_for_test_user_async(
        self,
        method: DeliveryMethod,
        login_id: str,
        login_options: Optional[LoginOptions] = None,
    ...
    async def generate_magic_link_for_test_user_async(
        self,
        method: DeliveryMethod,
        login_id: str,
        uri: str,
    ...
    async def generate_enchanted_link_for_test_user_async(
        self,
        login_id: str,
        uri: str,
        login_options: Optional[LoginOptions] = None,
    ...
    async def generate_embedded_link_async(
        self, login_id: str, custom_claims: Optional[dict] = None, timeout: int = 0
    ) -> str:
        """
        Generate Embedded Link for the given user login ID.
    ...
    async def generate_sign_up_embedded_link_async(
        self,
        login_id: str,
        user: Optional[CreateUserObj] = None,
        email_verified: bool = False,
    ...
    async def history_async(self, user_ids: List[str]) -> List[dict]:
        """
        Retrieve users' authentication history, by the given user's ids.
