...
class JWT(AuthBase):
    ...
    async def stop_impersonation_async(
        self,
        jwt: str,
        custom_claims: Optional[dict] = None,
        tenant_id: Optional[str] = None,
    ...
    async def sign_up_async(
        ...
        return await self._sign_up_internal_async(
            login_id, MgmtV1.mgmt_sign_up_path, user, signup_options
        )
    ...
    async def _sign_up_internal_async(
        self,
        login_id: str,
        endpoint: str,
        user: Optional[MgmtUserRequest] = None,
