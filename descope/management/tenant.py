...
class Tenant(AuthBase):
    ...
    async def load_async(
        ...
        Return value (dict):
        Return dict in the format
             {"id": <id>, "name": <n>, "selfProvisioningDomains": [], "customAttributes: {}, "createdTime": <timestamp>}
        Containing the loaded tenant information.
    ...
    async def load_all_async(
        ...
        Return value (dict):
        Return dict in the format
             {"tenants": [{"id": <id>, "name": <n>, "selfProvisioningDomains": [], customAttributes: {}, "createdTime": <timestamp>}]}
        Containing the loaded tenant information.
    ...
    async def search_all_async(
        ...
        Return value (dict):
        Return dict in the format
             {"tenants": [{"id": <id>, "name": <n>, "selfProvisioningDomains": [], customAttributes:{}}]}
        Containing the loaded tenant information.
