...
class ThirdPartyApplication(HTTPBase):
    def create(
        self,
        name: str,
        login_page_url: str,
        ...
        response = self._http.post(MgmtV1.thirdparty_application_create_path, body=body)
    ...
    def update(
        ...
        self._http.post(MgmtV1.thirdparty_application_update_path, body=body)
    ...
    def patch(
        ...
        self._http.post(MgmtV1.thirdparty_application_patch_path, body=body)
    ...
    def delete(self, id: str):
        ...
        """
        self._http.post(MgmtV1.thirdparty_application_delete_path, body={"id": id})
    ...
    def delete_batch(self, ids: List[str]):
        ...
        AuthException: raised if deletion operation fails
        """
        self._http.post(MgmtV1.thirdparty_application_delete_batch_path, body={"ids": ids})
    ...
    def load(self, id: str) -> dict:
        ...
        """
        response = self._http.get(MgmtV1.thirdparty_application_load_path, params={"id": id})
        return response.json()
    ...
    def load_all(self) -> dict:
        ...
        AuthException: raised if load operation fails
        """
        response = self._http.get(MgmtV1.thirdparty_application_load_all_path)
        return response.json()
    ...
    def rotate_secret(self, id: str) -> dict:
        ...
        """
        response = self._http.post(MgmtV1.thirdparty_application_rotate_path, body={"id": id})
        return response.json()

    def get_secret(self, id: str) -> dict:
        """
        ...
        """
        response = self._http.get(MgmtV1.thirdparty_application_secret_path, params={"id": id})
        return response.json()
    ...
    def delete_consents(
        ...
        self._http.post(MgmtV1.thirdparty_consents_delete_path, body=body)

    def delete_tenant_consents(self, tenant_id: str):
        """
        ...
        AuthException: raised if deletion operation fails
        """
        self._http.post(MgmtV1.thirdparty_consents_delete_tenant_path, body={"tenantId": tenant_id})
    ...
    def search_consents(
        ...
        if tenant_id is not None:
            body["tenantId"] = tenant_id
        response = self._http.post(MgmtV1.thirdparty_consents_search_path, body=body)
        return response.json()
