...
class ListsAsync(ListsBase, AsyncHTTPBase):
    """Async counterpart of Lists — all HTTP calls are coroutines."""
    ...
    async def delete(self, id: str):
        ...
        """
        await self._http.post(MgmtV1.list_delete_path, body=ListsBase._compose_delete_body(id))
    ...
    async def load(self, id: str) -> dict:
        ...
        """
        response = await self._http.get(MgmtV1.list_path, params={"id": id})
        return response.json()

    async def load_by_name(self, name: str) -> dict:
        """
        Load a list by name.
        ...
        AuthException: raised if load operation fails
        """
        response = await self._http.get(MgmtV1.list_name_path, params={"name": name})
        return response.json()
    ...
    async def load_all(self) -> dict:
        ...
        AuthException: raised if load operation fails
        """
        response = await self._http.get(MgmtV1.list_all_path)
        return response.json()

    async def import_lists(self, lists: List[dict]):
        """
        ...
        """
        await self._http.post(MgmtV1.list_import_path, body=ListsBase._compose_import_body(lists))

    async def add_ips(self, id: str, ips: List[str]):
        """
        ...
        """
        await self._http.post(MgmtV1.list_ip_add_path, body=ListsBase._compose_ip_body(id, ips))

    async def remove_ips(self, id: str, ips: List[str]):
        """
        ...
        AuthException: raised if operation fails
        """
        await self._http.post(MgmtV1.list_ip_remove_path, body=ListsBase._compose_ip_body(id, ips))

    async def check_ip(self, id: str, ip: str) -> bool:
        """
        ...
        AuthException: raised if operation fails
        """
        response = await self._http.post(MgmtV1.list_ip_check_path, body=ListsBase._compose_check_ip_body(id, ip))
        result = response.json()
        return result.get("exists", False)

    async def add_texts(self, id: str, texts: List[str]):
        """
        ...
        AuthException: raised if operation fails
        """
        await self._http.post(MgmtV1.list_text_add_path, body=ListsBase._compose_text_body(id, texts))

    async def remove_texts(self, id: str, texts: List[str]):
        """
        ...
        AuthException: raised if operation fails
        """
        await self._http.post(MgmtV1.list_text_remove_path, body=ListsBase._compose_text_body(id, texts))

    async def check_text(self, id: str, text: str) -> bool:
        """
        ...
        AuthException: raised if operation fails
        """
        response = await self._http.post(MgmtV1.list_text_check_path, body=ListsBase._compose_check_text_body(id, text))
        result = response.json()
        return result.get("exists", False)
    ...
    async def clear(self, id: str):
        ...
        AuthException: raised if operation fails
        """
        await self._http.post(MgmtV1.list_clear_path, body=ListsBase._compose_clear_body(id))
