...
class TestOTP(common.DescopeTest):
    ...
    def test_compose_update_user_phone_body(self):
        self.assertEqual(
            ...
            {"loginId": "dummy@dummy.com", "phone": "+11111111", "addToLoginIDs": False, "onMergeUseExisting": True},
        )
    ...
    def test_compose_update_user_email_body(self):
        self.assertEqual(
            ...
            {"loginId": "dummy@dummy.com", "email": "dummy@dummy.com", "addToLoginIDs": False, "onMergeUseExisting": True},
        )
