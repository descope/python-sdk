...
class TestDescopeClient(common.DescopeTest):
    ...
    async def test_my_tenants(self):
        ...
        # Test failed flow
        with mock_http_call(self.async_mode, "post") as mock_get:
            mock_get.return_value.ok = False
            with self.assertRaises(AuthException):
    ...
    async def test_validate_session_valid_tokens(self):
        ...
        with mock_http_call(self.async_mode, "get") as mock_request:
    ...
    async def test_expired_token(self):
        ...
        with mock_http_call(self.async_mode, "post") as mock_request:
            my_mock_response = mock.Mock()
            my_mock_response.ok = True
